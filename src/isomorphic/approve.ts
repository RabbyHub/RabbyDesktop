import { Spender, TokenApproval } from '@rabby-wallet/rabby-api/dist/types';
import { ApprovalItem, NFTInfoHost } from '@/renderer/utils/approval';
import { TokenSpenderPair } from './types/permit2';
import { obj2query, query2obj } from './url';

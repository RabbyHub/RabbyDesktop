...
export type RabbyXMethod = {
  ...
  'testnetOpenapi.setHost': OpenApiService['setHost'];
  'testnetOpenapi.getHost': OpenApiService['getHost'];
  'testnetOpenapi.ethRpc': OpenApiService['ethRpc'];
  'testnetOpenapi.init': OpenApiService['init'];
  'testnetOpenapi.getRecommendChains': OpenApiService['getRecommendChains'];
  'testnetOpenapi.getTotalBalance': OpenApiService['getTotalBalance'];
  'testnetOpenapi.getPendingCount': OpenApiService['getPendingCount'];
  'testnetOpenapi.checkOrigin': OpenApiService['checkOrigin'];
  'testnetOpenapi.checkText': OpenApiService['checkText'];
  'testnetOpenapi.checkTx': OpenApiService['checkTx'];
  'testnetOpenapi.preExecTx': OpenApiService['preExecTx'];
  'testnetOpenapi.historyGasUsed': OpenApiService['historyGasUsed'];
  'testnetOpenapi.pendingTxList': OpenApiService['pendingTxList'];
  'testnetOpenapi.traceTx': OpenApiService['traceTx'];
  'testnetOpenapi.pushTx': OpenApiService['pushTx'];
  'testnetOpenapi.explainText': OpenApiService['explainText'];
  'testnetOpenapi.gasMarket': OpenApiService['gasMarket'];
  'testnetOpenapi.getTx': OpenApiService['getTx'];
  'testnetOpenapi.getEnsAddressByName': OpenApiService['getEnsAddressByName'];
  'testnetOpenapi.searchToken': OpenApiService['searchToken'];
  'testnetOpenapi.searchSwapToken': OpenApiService['searchSwapToken'];
  'testnetOpenapi.getToken': OpenApiService['getToken'];
  'testnetOpenapi.listToken': OpenApiService['listToken'];
  'testnetOpenapi.customListToken': OpenApiService['customListToken'];
  'testnetOpenapi.listChainAssets': OpenApiService['listChainAssets'];
  'testnetOpenapi.listNFT': OpenApiService['listNFT'];
  'testnetOpenapi.listCollection': OpenApiService['listCollection'];
  'testnetOpenapi.listTxHisotry': OpenApiService['listTxHisotry'];
  'testnetOpenapi.tokenPrice': OpenApiService['tokenPrice'];
  'testnetOpenapi.tokenAuthorizedList': OpenApiService['tokenAuthorizedList'];
  'testnetOpenapi.userNFTAuthorizedList': OpenApiService['userNFTAuthorizedList'];
  'testnetOpenapi.getDEXList': OpenApiService['getDEXList'];
  'testnetOpenapi.getSwapQuote': OpenApiService['getSwapQuote'];
  'testnetOpenapi.getSwapTokenList': OpenApiService['getSwapTokenList'];
  'testnetOpenapi.postGasStationOrder': OpenApiService['postGasStationOrder'];
  'testnetOpenapi.getGasStationChainBalance': OpenApiService['getGasStationChainBalance'];
  'testnetOpenapi.getGasStationTokenList': OpenApiService['getGasStationTokenList'];
  'testnetOpenapi.explainTypedData': OpenApiService['explainTypedData'];
  'testnetOpenapi.checkTypedData': OpenApiService['checkTypedData'];
  'testnetOpenapi.approvalStatus': OpenApiService['approvalStatus'];
  'testnetOpenapi.usedChainList': OpenApiService['usedChainList'];
  'testnetOpenapi.getLatestVersion': OpenApiService['getLatestVersion'];
  'testnetOpenapi.addOriginFeedback': OpenApiService['addOriginFeedback'];
  'testnetOpenapi.getNetCurve': OpenApiService['getNetCurve'];
  'testnetOpenapi.getTokenHistoryPrice': OpenApiService['getTokenHistoryPrice'];
  'testnetOpenapi.getTokenHistoryDict': OpenApiService['getTokenHistoryDict'];
  'testnetOpenapi.getHistoryTokenList': OpenApiService['getHistoryTokenList'];
  'testnetOpenapi.getProtocolList': OpenApiService['getProtocolList'];
  'testnetOpenapi.getProtocol': OpenApiService['getProtocol'];
  'testnetOpenapi.getHistoryProtocol': OpenApiService['getHistoryProtocol'];
  'testnetOpenapi.getComplexProtocolList': OpenApiService['getComplexProtocolList'];
  'testnetOpenapi.getChainList': OpenApiService['getChainList'];
  'testnetOpenapi.getCachedTokenList': OpenApiService['getCachedTokenList'];
  'testnetOpenapi.checkSlippage': OpenApiService['checkSlippage'];
  'testnetOpenapi.getCEXSwapQuote': OpenApiService['getCEXSwapQuote'];
  'testnetOpenapi.getSwapTradeList': OpenApiService['getSwapTradeList'];
  'testnetOpenapi.postSwap': OpenApiService['postSwap'];
  'testnetOpenapi.getSummarizedAssetList': OpenApiService['getSummarizedAssetList'];
  'testnetOpenapi.collectionList': OpenApiService['collectionList'];
};

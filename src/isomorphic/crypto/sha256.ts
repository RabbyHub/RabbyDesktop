 ...
 *
 * @see https://github.com/kawanet/sha256-uint8array/blob/e8eca1752354cbd1401787b434ccef9ff9e788bc/lib/sha256-uint8array.ts
 */
...
export function getSha256(input: string) {

...
<<<<<<< HEAD
curl -sL https://download.rabby.io/_tools/RabbyX-v0.77.0-7bf82cb.zip > $assets_dir/rabbyx.zip
=======
curl -sL https://download.rabby.io/_tools/RabbyX-v0.76.0-84ff7e0.zip > $assets_dir/rabbyx.zip
>>>>>>> 1768098d (chore: update rabbyx)
